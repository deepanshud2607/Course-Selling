      ...
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        >
          <img
            ...
            src="https://i.ibb.co/9H6gwVYG/Gemini-Generated-Image-9bpxzf9bpxzf9bpx.png"
            alt="CourseHub"
          />
          CourseHub
        </Link>
        ...
        <ul className="flex items-center gap-4 text-sm font-medium text-slate-600 sm:gap-6">
          ...
          {userToken ? ( // user is signed in
            ...
            <>
              <li>
                <Link className="hover:text-slate-950" to="/admin/dashboard">
                  Seller studio
                </Link>
              </li>
              <li>
            ...
            <>
              <li>
                <Link className="hover:text-slate-950" to="/user/login">
                  Sign in
                </Link>
              </li>
              <li>
